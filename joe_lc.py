...
plt.savefig('/Users/james/Dropbox/research_projects/gj1243_spots/joe_lc_wide1.pdf', dpi=250, bbox_inches='tight')
plt.close()
# plt.show()
...
plt.xlabel('Time (days)')
plt.ylabel('Relative Flux')
plt.savefig('/Users/james/Dropbox/research_projects/gj1243_spots/joe_lc_trans.pdf', dpi=250, bbox_inches='tight')
plt.close()
# plt.show()
